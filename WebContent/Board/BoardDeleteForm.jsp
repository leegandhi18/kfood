...
<article>
	<div class="container" role="main">
		...
		<div class="table-response">
			...
			<div class="mb-3">
			<label for="date">글내용</label>
				<input type="text" class="form-control" name="content" id="content" value="${bean.content}" readonly><br/>
			</div>
				<input type="hidden" name="num" value="${bean.num}">
				<input type="hidden" name="pass" value="${bean.password}">
				<input type="hidden" name="pass" value="${bean.content}">
