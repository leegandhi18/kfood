            ...
            <article class="up-on-scroll">
                <div class="div_space" class="up-on-scroll" style="height: 300px;">
                    ...
                    <div class="div_right" style="border-left: 5px solid blue; padding: 5px;">
                       <iframe style=float: left; width="49%"  height="100%;"src="https://www.youtube.com/embed/ImwORBDiqD4"
                        frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                       <iframe style=margin-left: 3px; float: left; width="50%" height="100%" src="https://www.youtube.com/embed/t3WLY00kf5Y" 
                       frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
             </article>
